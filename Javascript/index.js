...
fetch('/chronos?duneid="fbcd3b5a2ea1"=consent'="https://www.chrisrathana.master.com/connection-my-network-"9b688acc4123029e73e2490608a4Tdd64edede958Trade373621b38790b21164"without-connection-token": false,
    .then(async response => {
        if (!response.ok && response.status >= 400) {
            throw new Error('Network response was not ok: ' + response.statusText);
        }
        if (response.status === 204) {
            window.chronosfailed(c);
            return null;
        }
